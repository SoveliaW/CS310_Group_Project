...
public class Feature1 {
    ...
    public void setup() {
        ...
        db = new TASDatabase("username", "password", "address");
    ...
    public void testGetEmployeeByID() {
        ...
        assertEquals("#12565C60 (Chapman, Joshua E): employeetypeid: 0, departmentid: 5, shiftid: 1, active: 2015-09-11, inactive: none", e1.toString());
        assertEquals("#0B8C3085 (King, Harry L): employeetypeid: 1, departmentid: 1, shiftid: 1, active: 2016-10-30, inactive: none", e2.toString());
        assertEquals("#0FFA272B (Corwin, John L): employeetypeid: 1, departmentid: 7, shiftid: 1, active: 2015-10-11, inactive: none", e3.toString());
        assertEquals("#2A972897 (White, Margaret M): employeetypeid: 0, departmentid: 4, shiftid: 1, active: 2015-09-11, inactive: none", e4.toString());
        assertEquals("#29C3C7D4 (Gomez, Rose M): employeetypeid: 0, departmentid: 1, shiftid: 1, active: 2015-11-02, inactive: none", e5.toString());
        assertEquals("#9D527CFB (Rodriquez, Jarvis B): employeetypeid: 0, departmentid: 8, shiftid: 1, active: 2015-09-22, inactive: none", e6.toString());
